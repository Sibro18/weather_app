#include "geo-parsing-data.h"

namespace GeoNames
{
    QJsonObject GeoParsingData::toJson() const
    {
        QJsonObject obj;
    ...
    void GeoParsingData::fillFromJsonObject(const QJsonObject &obj)
    {
    ...
    QVariantMap GeoParsingData::toVariantMap() const
    {
        return {
            {"adminName", adminName},
    ...
    GeoParsingData GeoParsingData::convertToGeoParsingData(const QVariantMap &data)
    {
        GeoParsingData result;
    ...
    bool GeoParsingData::operator==(const GeoParsingData& other) const
    {
